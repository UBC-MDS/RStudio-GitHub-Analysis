...
We used the gap statistic to choose an optimal number of clusters (Supplemental Table 1). Ultimately settling on 19. The results of this clustering is shown below in a dimensionality reduced T-SNE plot. 
