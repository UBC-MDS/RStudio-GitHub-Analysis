...
Using Graph2Vec to generate embeddings, we were able to identify clusters at a global level.
...
This indicates to us that there are identifiable workflow patterns in git graphs.
