...
def main(n_projects, n_workers, data_path, results_path):
    ...
    personas = p.getPersonas(clusters, commits_dl)
...
if __name__ == '__main__':
    ...
    parser.add_argument("-rp", "--results_path", help="The folder to output results of the analysis. e.g. embeddings and plots")
